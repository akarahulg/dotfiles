...
-- https://github.com/streetturtle/statusbar/tree/master/pactl-widget
...
local pactl = require("statusbar.pactl-widget.pactl")
local utils = require("statusbar.pactl-widget.utils")


local widget_types = {
    icon_and_text = require("statusbar.volume-widget.widgets.icon-and-text-widget"),
    icon = require("statusbar.volume-widget.widgets.icon-widget"),
    arc = require("statusbar.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("statusbar.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("statusbar.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
...
local function worker(user_args)
    ...
    volume.widget:buttons(
            awful.util.table.join(
                    ...
                    awful.button({}, 2, function() volume:popup() end),
